 ...
 * generated in the cxf.orders package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://orders.cxf/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://orders.cxf/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://orders.cxf/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://orders.cxf/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cxf.orders
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://orders.cxf/", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://orders.cxf/", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://orders.cxf/", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://orders.cxf/", name = "createOrdersResponse")
