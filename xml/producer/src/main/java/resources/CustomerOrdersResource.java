...
@WebService(portName = "CustomerOrdersResourcePort", serviceName = "CustomerOrdersResource",
        wsdlLocation = "WEB-INF/wsdl/CustomerOrders.wsdl", targetNamespace = "http://orders.resources/")
