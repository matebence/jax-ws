...
@WebService(portName = "PaymentResourcePort", serviceName = "PaymentResource", wsdlLocation = "WEB-INF/wsdl/Payment.wsdl")
public class PaymentResource {

    //if we access this url https://localhost:8443/xml/PaymentResource?wsdl and save the wsdl file
