 ...
 * generated in the resources.orders package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://orders.resources/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://orders.resources/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://orders.resources/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://orders.resources/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: resources.orders
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://orders.resources/", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://orders.resources/", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://orders.resources/", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://orders.resources/", name = "createOrdersResponse")
